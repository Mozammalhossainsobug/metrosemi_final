...
import imgfsm413sa from '../../../images/fsm413sa.png'


export default function Fsm413SA() {
  return (
    <> 
     <div className='UpperFsm413C2C'>    
      
      <h3>FSM 413 SA-300 Wafer Thickness Mapper</h3>
...
are also optionally available.
            ...
            <div class="col-sm-4">
                <img src={imgfsm413sa} width="350" height="300" />
            </div>      
      </div>
